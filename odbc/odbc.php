 ...
 * </p>
 * @return array{server:string, description:string}|false|null <b>FALSE</b> on error, and an array upon success.
 */
 ...
 */
function odbc_exec($odbc, string $query, #[StubsElementAvailable(from: '5.3', to: '7.4')] $flags = null) {}
