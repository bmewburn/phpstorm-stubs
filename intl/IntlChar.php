...
class IntlChar
{
     ...
     * @param _IntlCharUnicodePropertiesArgSet $property The Unicode property to lookup (see the IntlChar::PROPERTY_* constants).
     ...
     * @param \IntlChar::UNICODE_CHAR_NAME|\IntlChar::UNICODE_10_CHAR_NAME|\IntlChar::EXTENDED_CHAR_NAME|\IntlChar::CHAR_NAME_ALIAS|\IntlChar::CHAR_NAME_CHOICE_COUNT $type [optional] <p>
     ...
     * @param int|string $codepoint The integer codepoint value (e.g. 0x2603 for U+2603 SNOWMAN), or the character encoded as a UTF-8 string (e.g. "\u{2603}")
     * @param \IntlChar::FOLD_CASE_DEFAULT|\IntlChar::FOLD_CASE_EXCLUDE_SPECIAL_I $options [optional] Either IntlChar::FOLD_CASE_DEFAULT (default) or IntlChar::FOLD_CASE_EXCLUDE_SPECIAL_I.
     ...
     * @param _IntlCharUnicodePropertiesArgSet $property <p>The Unicode property to lookup (see the IntlChar::PROPERTY_* constants).</p>
     * <p><b>IntlChar::PROPERTY_INVALID_CODE</b> should not be used. Also, if property is out of range, FALSE is returned.</p>
     * @param _IntlCharPropertyNameChoicesArgSet $type <p> Selector for which name to get. If out of range, FALSE is returned.</p>
     ...
     * @param _IntlCharUnicodePropertiesArgSet $property <p>The Unicode property to lookup (see the IntlChar::PROPERTY_* constants).
     ...
     * @param _IntlCharUnicodePropertiesArgSet $property <p>
     ...
     * </p>
     * @param _IntlCharBlockCodePropertyValuesArgSet|_IntlCharOtherEnumPropertyValuesArgSet $value <p>
     ...
     * </li>
     * </ul>
     * @param _IntlCharPropertyNameChoicesArgSet $type [optional] <p>
