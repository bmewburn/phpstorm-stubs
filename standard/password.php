 ...
 * @param PASSWORD_DEFAULT|PASSWORD_BCRYPT|PASSWORD_ARGON2I|PASSWORD_ARGON2ID|null $algo A <a href="https://secure.php.net/manual/en/password.constants.php" class="link">password algorithm constant</a>  denoting the algorithm to use when hashing the password.
