 ...
 * @param int $julian_day
 * @param CAL_MONTH_GREGORIAN_SHORT|CAL_MONTH_GREGORIAN_LONG|CAL_MONTH_JULIAN_SHORT|CAL_MONTH_JULIAN_LONG|CAL_MONTH_JEWISH|CAL_MONTH_FRENCH $mode
 ...
 */
function easter_date(?int $year, #[StubsElementAvailable(from: '8.0')] int $mode = CAL_EASTER_DEFAULT): int {}
 ...
 *  abbrevmonth:string,
 *  monthname:string
 * } an array containing calendar information like month, day, year,
 ...
 * </p>
 * @return array{months:array, abbrevmonths:array, maxdaysinmonth:int, calname:string, calsymbol:string}
 */
